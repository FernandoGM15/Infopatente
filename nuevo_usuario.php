    ...
    <div class="container-fluid row red accent-4 valign-wrapper z-depth-3">
      ...
      <div class="col l3 right-align">
        <div class="col s12 white-text">
          <a href="nueva_empresa.php" class="btn red lighten-4 black-text"><i class="material-icons tiny left">store</i><span class="hide-on-med-and-down">Nueva Empresa</span></a>
        </div>
      </div>
    </div>
          ...
          <div class="card-content row">
            ...
            <div class="col l12" id='registro_folio'>
              <div class="input-field col l4 offset-l2">
                  ...
                  <select id='nombre_empresa'>
                    <option value="" disabled selected>Nombre de la empresa</option>
                    <option value="Alumno">Alumno</option>
                    <option value="Profesor">Profesor</option>
                    <option value="Empleado">Trabajador de empresa</option>
                    <option value="Abogado">Abogado</option>
            ...
            <div class="col l12 right-align">
              <div class="col l4 right">
                <button type="submit" class='btn red'>Registrar</button>
              </div>
            </div>
          </div>
        </div>
